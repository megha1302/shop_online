...
class OrderproductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create orderproduct" do
    assert_difference('Orderproduct.count') do
      post orderproducts_url, params: { orderproduct: { order_id: @orderproduct.order_id, product_id: @orderproduct.product_id, quantity: @orderproduct.quantity } }
    end
  ...
  test "should update orderproduct" do
    patch orderproduct_url(@orderproduct), params: { orderproduct: { order_id: @orderproduct.order_id, product_id: @orderproduct.product_id, quantity: @orderproduct.quantity } }
